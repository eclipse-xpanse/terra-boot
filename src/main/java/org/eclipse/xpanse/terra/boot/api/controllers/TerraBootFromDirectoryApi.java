...
public class TerraBootFromDirectoryApi {
    ...
    public TerraformValidationResult validateFromDirectory(
        ...
        log.info("Validating Terraform scripts from directory.");
    ...
    @PostMapping(value = "/{requestType}", produces = MediaType.APPLICATION_JSON_VALUE)
    @ResponseStatus(HttpStatus.OK)
    public TerraformResult deployFromDirectory(
            @Valid @RequestBody TerraformRequestWithScriptsDirectory request) {
        request.setRequestType(RequestType.DEPLOY);
    ...
    public TerraformResult modifyFromDirectory(
            @Valid @RequestBody TerraformRequestWithScriptsDirectory request) {
        request.setRequestType(RequestType.MODIFY);
        return requestService.handleTerraformRequest(request);
    }
    ...
    public TerraformResult destroyFromDirectory(
            @Valid @RequestBody TerraformRequestWithScriptsDirectory request) {
        request.setRequestType(RequestType.DESTROY);
        return requestService.handleTerraformRequest(request);
    }
